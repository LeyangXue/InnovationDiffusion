...
if __name__ == '__main__':
    ...
    root_path = 'F:/work/work4_dynamic' #change the current path if run this code
    ResultPath = root_path + '/InnovationDiffusion/sfigure1/result'
    figurePath = root_path + '/InnovationDiffusion/sfigure1/figure'
    ...
    ax[0].text(0.005,0.14, r'$\rho$ = '+str(round(s_rho_r,2))+'***', fontdict=font_label)
    ...
    ax[1].text(0.005,10.2, r'$\rho$ = '+str(round(s_time_r,2))+'***', fontdict=font_label)

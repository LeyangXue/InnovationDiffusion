...
if __name__ == '__main__':
    ...
    modelnetworkpath = root_path + '/InnovationDiffusion/sfigure2/network/modelnetworks'
    realnetworkpath = root_path + '/InnovationDiffusion/sfigure2/network/realnetworks'
    resultpath = root_path + '/InnovationDiffusion/sfigure2/result'
